...
const PinDescription g_APinDescription[]=
{
  ...
  // 37/38 I2C (SDA/SCL and also EDBG:SDA/SCL) => Legacy from Arduino M0
  ...
  // 39 .. 41 - BG96 
  { PORTA, 19, PIO_SERCOM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // BG96 POWER KEY
  { PORTA, 16, PIO_SERCOM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // BG96 RESET
